...
const button = "flex flex-row items-center";
const basicButton =
    "bg-white border-none outline-none flex justify-center items-center w-9 h-9 rounded-full cursor-pointer transition-colors mr-1";
const count = "font-sm text-slate-400";
...
export default function ActionButtons({ white, post }: Props) {
    ...
    return (
        <div className="flex justify-between flex-row gap-x-1 mt-3">
            <div className={cx(style.commentButton, white && style.white)}>
                <button className={basicButton} onClick={onClickComment}>
                    <svg className="fill-slate-400" width={24} viewBox="0 0 24 24" aria-hidden="true">
                        <g>
            ...
            <div className={cx(button, reposted && style.reposted, white && style.white)}>
                <button className={basicButton} onClick={onClickRepost}>
            ...
            <div className={cx([button, liked && style.liked, white && style.white])}>
                <button className={basicButton} onClick={onClickHeart}>
                    <svg width={24} viewBox="0 0 24 24" aria-hidden="true">
                        <g>
