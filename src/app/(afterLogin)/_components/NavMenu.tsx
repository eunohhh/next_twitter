...
const navPill = "inline-flex items-center h-[50px] p-3";
const navPillDiv = "ml-5 mr-4 text-lg";
                    ...
                    <div className={navPill}>
                        {segment === "home" ? (
                            <>
                                ...
                                <div className={navPillDiv} style={{ fontWeight: "bold" }}>
                                    홈
                                </div>
                            </>
                        ) : (
                            <>
                                ...
                                <div className={navPillDiv}>홈</div>
                            </>
                        )}
                    </div>
                </Link>
                    ...
                    <div className={navPill}>
                        {segment && ["search", "explore"].includes(segment) ? (
                            ...
                            <>
                                ...
                                <div className={navPillDiv}>탐색하기</div>
                            </>
                        )}
                    </div>
                </Link>
                    ...
                    <div className={navPill}>
                        {segment === "messages" ? (
                            ...
                            <>
                                ...
                                <div className={navPillDiv}>쪽지</div>
                            </>
                        )}
                    </div>
                </Link>
                        ...
                        <div className={navPill}>
                            {segment === me.id ? (
                                ...
                                <>
                                    ...
                                    <div className={navPillDiv}>프로필</div>
                                </>
                            )}
                        </div>
                    </Link>
